...
export const constantRouterMap = [{
  ...
  // },
  {
    path: '/wantForjJobContact',
    component: Layout,
    redirect: '/wantForjJobContact/index/job',
    meta: {
      title: '求职联系',
    ...
    children: [{
      path: 'index',
      hidden: true,
      component: () => import('@/views/wantForjJobContact/index'),
      children: [{
        path: 'job',
        hidden: true,
        component: () => import('@/views/wantForjJobContact/job'),
        meta: {
          title: '求职列表'
        }
      }]
